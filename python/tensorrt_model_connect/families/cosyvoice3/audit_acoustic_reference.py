...
def main(argv=None):
    ...
    if sha256_file(artifact) != evidence_report["evidence_sha256"]:
        raise ValueError("Acoustic evidence checksum mismatch")
    ...
    report = {"scope": "diagnostic_reference_only_not_native_acceptance", "collection_complete": True,
              ...
              "evidence_sha256": evidence_report["evidence_sha256"], "torch_version": torch.__version__,
